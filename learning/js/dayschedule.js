...
if(result == 'Субота' || result == 'Неділя')
{
    today_schedule.innerHTML = '<p class="card-title day_name">' + 'Сьогодні пар немає!' + '</p>';
}
else
{
    today_schedule.innerHTML = '<p class="card-title day_name">' + result + '</p>';
}
